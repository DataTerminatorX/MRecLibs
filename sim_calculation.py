...
具体的：
    ...
    2. 修改 get_sim_dict() 函数，输入参数增加 sim_type 用于选择相似度类型
...
def get_sim_list (uidict, intype, form_type):
    # 功能: 计算jaccard相似度
    # 输入参数:
    ...
    for key1, value1 in uidict.items():
        for key2,value2 in uidict.iteritems():
            if key1 == key2:          
                continue
            sim_list.append( (key1, key2, jaccard_formula(value2,value1,intype, form_type) ) )
